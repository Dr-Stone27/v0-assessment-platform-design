...
export default function ResultsPage() {
  ...
  const [personalizedReport, setPersonalizedReport] = useState<PersonalizedReport | null>(null)
  ...
  useEffect(() => {
    ...
    if (!state.profile) {
      try {
        const calculatedProfile = calculateCompleteProfile(state.responses, state.demographics)
  ...
  useEffect(() => {
    async function fetchPersonalizedReport() {
      ...
      try {
        ...
        setReportError("Unable to generate personalized report. Please try again later.")
      } finally {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">Calculating your learning profile...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-muted-foreground">{profile.personaIdentity}</p>
          </div>
          ...
          <Card className="border-2 border-primary/20">
            <CardHeader>
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  <CardTitle className="text-3xl">{profile.layer4_archetype.primary.name}</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Secondary archetype:{" "}
                <span className="font-medium text-foreground">{profile.layer4_archetype.secondary.name}</span> (
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-2xl font-bold capitalize">{profile.layer2_mindset.type} Mindset</p>
          ...
          <Tabs defaultValue="report" className="space-y-6">
            ...
            <TabsContent value="overview" className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <RadarChart metrics={profile.layer1_detailedMetrics} size={500} />
                </CardContent>
              </Card>
                      ...
                      {metrics
                        ...
                        .map(([key, metric]) => (
                          <li key={key} className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="font-medium text-sm">{METRIC_DESCRIPTIONS[key].name}</p>
            ...
            <TabsContent value="metrics" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Detailed breakdown of your scores across all metrics</CardDescription>
                </CardHeader>
          ...
          <Card className="bg-muted/50">
            <CardContent className="pt-6">
              <div className="text-center text-sm text-muted-foreground space-y-2">
                ...
                <p>
                  <strong>Completed:</strong> {new Date(profile.calculatedAt).toLocaleString()}
                </p>
              </div>
            </CardContent>
          </Card>
